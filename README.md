...
|---|---|---|
| **GlobalXport** | AI-powered trade documentation and export workflow platform | `Next.js` `FastAPI` `LangChain` `AI` |
| **Hira** | Modern full-stack product platform with scalable architecture | `Next.js` `React` `Vercel` |
| **Smart Parking System** | Intelligent parking management and slot allocation system | `Python` `IoT` `MySQL` |
| **Portfolio Website** | Personal developer portfolio and project showcase | `HTML` `CSS` `JavaScript` |
...
<img src="https://github-profile-trophy.vercel.app/?username=jeeva74&no-frame=true&no-bg=true&row=1&column=6" width="100%" />
...
<img src="https://github-readme-activity-graph.vercel.app/graph?username=jeeva74&hide_border=true" width="100%" />
...
<img src="https://capsule-render.vercel.app/api?type=waving&height=130&section=footer&text=Code+Learn+Build+Repeat&fontSize=20"/>
